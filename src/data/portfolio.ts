...
export const DEFAULT_USER: UserProfile = {
  ...
  works: [
    { label: 'Github', url: 'http://example_github.com' },
    { label: 'Gitlab', url: 'http://example_gitlab.com' },
    { label: 'Behance', url: 'http://example_behance.com' },
  ],
  contacts: {
    phone: '+7(999)-123-45-67',
    email: 'prog_it@mail.com',
